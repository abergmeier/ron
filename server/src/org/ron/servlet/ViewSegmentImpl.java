...
implements ViewSegment
{
	...
	public ViewSegmentImpl(Segment segment, int playerId, float startLatitude, float startLongitude, float endLatitude, float endLongitude)
	{
		_segment = segment;
		_playerId = playerId;
